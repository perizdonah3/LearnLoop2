...
fun ProgressTrackerScreen(navController: NavHostController) {
    ...
    Column(
        ...
        ProgressCard(Icons.Default.CheckCircle, "Tasks Completed", "41")
        Spacer(modifier = Modifier.height(12.dp))

        ProgressCard(Icons.Default.Timer, "Study Hours", "56 hrs")
        Spacer(modifier = Modifier.height(12.dp))

        ProgressCard(Icons.Default.BarChart, "Quiz Average", "91%")
        Spacer(modifier = Modifier.height(12.dp))

        ProgressCard(Icons.Default.TrendingUp, "Weekly Growth", "+12%")
